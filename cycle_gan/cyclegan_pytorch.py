...
class cyclegan(nn.Module):
    ...
    def __init__(self, num_classes, batch_size, learning_rate, device, seg=30):
        ...
        self.x_dim = 3 * 3 * 256 #seg * 75
        self.y_dim = 3 * 3 * 256 #seg * 75
    ...
    def forward(self, subject_1, subject_2, labels, noise, eval_mode=False):
        ...
        G1_loss_fea = self.compute_generator_loss(generate_fake_z2,
                                                  subject_2)  # self.reconstruction_criterion(generate_fake_z2, subject_2) # generated feature similiarity
        G2_loss_fea = self.compute_generator_loss(generate_fake_z1,
        ...
        for epoch in range(epochs):
            ...
            if epoch % 50 == 0 and epoch != 0:
                ...
                with torch.no_grad():
                    ...
                    print('Iteration = ', epoch, '  Accuracy:  Subject_1_2 = %.4f' % np.mean(acc_te_r1r2_num),
            ...
            print('Iteration = ', epoch, '  Loss_G_1 = %.4f' % np.mean(G1_loss), ' Loss_G_2 = %.4f' % np.mean(G2_loss),
