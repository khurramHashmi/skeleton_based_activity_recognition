        ...
        for epoch in range(epochs):
            ...
            if epoch % 50 == 0 and epoch != 0:
                ...
                with torch.no_grad():
                    ...
                    acc_te_r1r2_num, acc_te_r1f2_num, acc_te_f1r2_num = [], [], []
                    ...
                    print('Epoch = ', epoch, '  Accuracy:  Subject_1 = %.4f' % np.mean(acc_te_r1f2_num), ' Subject_2 = %.4f' % np.mean(acc_te_f1r2_num),
                          '  Subject_1_2 = %.4f' % np.mean(acc_te_r1r2_num))
...
train_dataset = dataset_loader.pytorch_dataloader(batch_size, train_path='/home/ahmed/Desktop/datasets/skeleton_dataset/cross_subject_data/trans_train_data.pkl', seg=seg)
train_loader = DataLoader(train_dataset, batch_size=batch_size, shuffle=False, drop_last=True, **kwargs)
eval_dataset = dataset_loader.pytorch_dataloader(eval_batch_size, test_path='/home/ahmed/Desktop/datasets/skeleton_dataset/cross_subject_data/trans_test_data.pkl', is_train=False, seg=seg)
