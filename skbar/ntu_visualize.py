...
def visualize(args):
    ...
    for index in range(10,16000,60):
...
if __name__ == '__main__':
    ...
    parser.add_argument('-p', '--datapath',
                        help='location of dataset numpy file', default="/home/hashmi/Desktop/dataset/activity_recognition/ntu/xsub/val_data_joint.npy")
    parser.add_argument('-l', '--labelpath',
                        help='location of label pickle file', default="/home/hashmi/Desktop/dataset/activity_recognition/ntu/xsub/val_label.pkl")
