...
def train():
    ...
    train_dataset = SkeletonsDataset('data/skel_train.tsv')
...
def evaluate(eval_model):
    ...
    eval_dataset = SkeletonsDataset('data/skel_train.tsv')
    eval_loader = DataLoader(eval_dataset, batch_size=1, shuffle=False, **kwargs)
    # ntokens = 15400
    with torch.no_grad():
...
ntokens = 15400 # the size of vocabulary
