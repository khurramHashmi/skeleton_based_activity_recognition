...
class InceptionResnetV1(nn.Module):
    ...
    def __init__(self, pretrained=None, classify=False, num_classes=None, dropout_prob=0.6, num_channels=3, device=None):
        ...
        self.conv2d_3b = BasicConv2d(96, 112, kernel_size=1, stride=1)
        self.conv2d_4a = BasicConv2d(112, 224, kernel_size=3, stride=1)
        self.conv2d_4b = BasicConv2d(224, 256, kernel_size=3, stride=2)
        ...
        if pretrained is not None:
            self.logits = nn.Linear(128, tmp_classes)
