...
def visualize(args):
    ...
    # data_path = "/home/hashmi/Desktop/dataset/activity_recognition/NTURGBD-60_120/ntu_60/cross_subject_data/test_trans_pkl.npy"
    ...
    for index in range(21,321,60):
        ...
        # skeletons = np.array(skeletons).reshape(len(skeletons),25,3)
        action_class = labels[1][index] + 1
        action_name = actions[action_class]
...
if __name__ == '__main__':
    ...
    parser.add_argument('-p', '--datapath',
                        help='location of dataset numpy file', default="/home/hashmi/Desktop/dataset/activity_recognition/ntu_msg3f/xsub/train_stand_msg3_CS.npy")
