...
class SkeletonsDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # file_name = "."+self.data_files_info.iloc[idx,0] # need to be used when script is being called inside embeddings folder
        ...
        labels = torch.tensor(labels[:75], dtype=torch.long) #for skeleton because 75 skeletons in one video
