...
parser.add_argument("-tr_d", "--train_data", default='./train_norm_cls.csv', help='Path to training data')
parser.add_argument("-ev_d", "--eval_data", default='./val_norm_cls.csv', help='Path to eval data')
...
parser.add_argument("-c", "--checkpoint", help="path to store model weights", default="./logs/verifying_less_class")
