...
# ntu_skeleton_bone_pairs_update = tuple((i-1, j-1) for (i,j) in (
#     (1, 2), (2, 21), (3, 21), (4, 3), (5, 21), (6, 5),
#     (7, 6), (8, 7), (9, 21), (10, 9), (11, 10), (12, 11),
#     (13, 1), (14, 13), (15, 14), (17, 1), (18, 17),
#     (19, 18), (22, 23), (21, 21), (23, 8), (24, 25),(25, 12)
# ))
ntu_skeleton_bone_pairs = tuple((i-1, j-1) for (i,j) in (
    (1, 2), (2, 21), (3, 21), (4, 3), (5, 21), (6, 5),
    (7, 6), (8, 7), (9, 21), (10, 9), (11, 10), (12, 11),
...
def visualize(args):
    ...
    #
    # test_data = np.load("/home/hashmi/Desktop/dataset/activity_recognition/ntu_msg3f/xsub/val_data_joint.npy", mmap_mode='r')
    ...
    # skeletons = data[21]
    stand_avatar = data[86][..., 0].transpose(1, 0, 2)
    # sit_avatar = data[8][..., 0].transpose(1, 0, 2)
    # Pick the first body to visualize
    # skeleton1 = skeletons[..., 0]   # out (C,T,V)
    # base_avatar = np.array(base_avatar).reshape(len(base_avatar), 25, 3)
    skeleton_index = [0]
    # skeleton_frames = skeleton1.transpose(1,0,2)
    # avatar = np.zeros_like(skeletons)
    # avatar[:, :, :] = skeletons[0, :, :]
    data_write = []
    # for index in range(0, 1000, 60):
    ...
    #     ani = FuncAnimation(fig, animate, avatar_stand)
...
if __name__ == '__main__':
    ...
    parser.add_argument('-p', '--datapath',
                        help='location of dataset numpy file', default="/home/hashmi/Desktop/dataset/activity_recognition/ntu_msg3f/xsub/val_data_joint.npy")
    parser.add_argument('-l', '--labelpath',
                        help='location of label pickle file', default="/home/hashmi/Desktop/dataset/activity_recognition/ntu_msg3f/xsub/val_label.pkl")
    ...
    parser.add_argument('-t', '--type',
                        help='type of file train or val', default="val_small_stand_msg3_CS")
